...
//      COMPLETED (7) Display the weather icon using mDetailBinding
        ...
        int weatherLogoId = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId);
        mDetailBinding.primaryWeatherInfo.weatherIcon.setImageResource(weatherLogoId);
...
//      COMPLETED (15) Create the content description for the description for a11y
        String weatherIconContentDescription = getString(R.string.a11y_forecast, description);
...
//      COMPLETED (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryWeatherInfo.weatherIcon.setContentDescription(weatherIconContentDescription);
        mDetailBinding.primaryWeatherInfo.weatherDescription.setContentDescription(weatherIconContentDescription);
...
//      COMPLETED (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.highTemperature.setContentDescription(highTempContentDescription);
...
//      COMPLETED (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.lowTemperature.setContentDescription(lowTempContentDescription);
...
//      COMPLETED (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.extraWeatherDetail.tvHumidity.setText(humidityString);

//      COMPLETED (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraWeatherDetail.tvHumidityLabel.setContentDescription(humidityContentDescription);
...
//      COMPLETED (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extraWeatherDetail.tvWind.setText(windString);

//      COMPLETED (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraWeatherDetail.tvWindLabel.setContentDescription(windContentDescription);
...
//      COMPLETED (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.extraWeatherDetail.tvPressure.setText(pressureString);

//      COMPLETED (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraWeatherDetail.tvPressureLabel.setContentDescription(pressureContentDescription);

...
//      COMPLETED (7) Replace the single TextView with Views to display all of the weather info
        ...
        Double tempHight = mCursor.getDouble(MainActivity.INDEX_WEATHER_MAX_TEMP);
         /* Read low temperature from the cursor (in degrees celsius) */
        Double tempLow = (mCursor.getDouble(MainActivity.INDEX_WEATHER_MIN_TEMP));
        StringBuffer lowInCelsius = new StringBuffer()
                .append(String.valueOf(tempLow.intValue()))
                .append('\u00B0');
        StringBuffer highInCelsius = new StringBuffer()
                .append(String.valueOf(tempHight.intValue()))
                .append('\u00B0');
        int imageId = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId);
        forecastAdapterViewHolder.ivWeatherLogo.setImageResource(imageId);
        forecastAdapterViewHolder.tvDate.setText(dateString);
        forecastAdapterViewHolder.tvWeatherDescription.setText(description);
        forecastAdapterViewHolder.tvTempLow.setText(lowInCelsius);
        forecastAdapterViewHolder.tvTempHigh.setText(highInCelsius);
    }

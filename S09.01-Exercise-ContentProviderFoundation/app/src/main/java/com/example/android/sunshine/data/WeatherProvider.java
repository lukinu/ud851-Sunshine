...
public class WeatherProvider extends ContentProvider {
    ...
    // mOpenHelper holds a Weather DB helper
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        // add URIs to match into the matcher
        ...
        // return the matcher we've built
        return uriMatcher;
    }
...
//  COMPLETED (8) Provide an implementation for the query method
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        // get a readable DB from helper
        final SQLiteDatabase db = mOpenHelper.getReadableDatabase();
        // match a uri
        Integer uriMatchCode = sUriMatcher.match(uri);
        // declare a Cursor to return
        Cursor retCursor;

//      COMPLETED (9) Handle queries on both the weather and weather with date URI
        // Query for weather data according to Uri
        switch (uriMatchCode) {
            // query entire table
            case CODE_WEATHER:
            ...
            case CODE_WEATHER_WITH_DATE:
                // get date from Uri
                String strDate = uri.getPathSegments().get(1);
                // setup selection string
                String _selection = WeatherContract.WeatherEntry.COLUMN_DATE + "=?";
                // setup selection argument
                String[] _selectionArgs = new String[]{strDate};
                // get Cursor by query
                retCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME,
                        projection,
                        _selection,
